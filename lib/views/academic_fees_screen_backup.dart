...
class _AcademicFeesScreenState extends State<AcademicFeesScreen>
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildStatCard(
                      ...
                      Icons.check_circle,
                      const Color(0xFF1E40AF), // Changed to darker blue
  ...
  Widget _buildFiltersSection() {
    return SliverToBoxAdapter(
      child: Padding(
        padding: const EdgeInsets.fromLTRB(16, 0, 16, 0), // Removed top padding
        child: Column(
          children: [
            // Search Bar
            Container(
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF3B82F6), // Changed to blue
                    foregroundColor: Colors.white,
